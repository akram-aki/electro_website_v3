...
const ClubRegistrationsAdmin = () => {
    ...
    const fetchRegistrations = async () => {
        if (!adminToken.trim()) {
            setError('Please enter admin token to fetch data');
            return;
        }
    ...
    return (
        <div className="bg-gray-100 min-h-screen p-6 rounded shadow">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                    ...
                    <div className="flex items-center gap-2 w-full md:w-auto">
                        <input
                            ...
                            className="px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-[#70a939] w-full md:w-64"
                        />
                        <button
                            onClick={fetchRegistrations}
                            disabled={loading}
                            className="bg-[#70a939] hover:bg-green-600 text-white px-4 py-2 rounded transition duration-300 whitespace-nowrap"
                        >
